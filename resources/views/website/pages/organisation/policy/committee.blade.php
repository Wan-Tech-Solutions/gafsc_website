...
@section('content')
    <main class="main">
        ...
        <div class="site-breadcrumb" style="background: url({{ asset('img/bg/bg-1.png') }})">
            <div class="container">
                <h2 class="breadcrumb-title">Policy Committee</h2>
                <ul class="breadcrumb-menu">
                    <li><a href="/">Home</a></li>
                    <li><a href="javascript:void(0)">Organisation</a></li>
                    <li class="active">Policy Committee</li>
                </ul>
            </div>
        </div>
        --}}
                ...
                <div class="row">
                    <div class="col-lg-6 mx-auto">
                        <div class="site-heading text-center">
                            ...
                            <h2 class="site-title">Policy Committee</h2>
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="team-item wow fadeInUp" data-wow-delay=".25s"
                            ...
                            <div class="team-content">
                                <div class="team-bio">
                                    <h6><a href="javascript:void(0)">DR VLADIMIR ANTWI-DANSO
                                    </a></h6>
                                    <span>(DEAN, MEMBER)</span>
                                </div>
                                <h6 class="text-blue-600"><a href="{{ route('organisation.academic-board.dean') }}">READ PROFILE</a></h6>
                            </div>
                        </div>
                    </div>
