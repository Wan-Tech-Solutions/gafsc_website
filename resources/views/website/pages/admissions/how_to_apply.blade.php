...
@section('content')
    <main class="main">
                        ...
                        <div class="content-info wow fadeInUp" data-wow-delay=".25s"
                            ...
                            <div class="site-heading mb-3">
                                <span class="site-title-tagline"><i class="far fa-book-open-reader"></i> How To
                                    Apply</span>
                                <h2 class="site-title">
                                    Details About <span>How To Apply</span> Educa.
                                </h2>
                            </div>
                            ...
                            <p class="content-text mt-2">
                                Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium veritatis et
                            ...
                            <div class="content-btn">
                                <a href="how-to-apply.html#" class="theme-btn">Apply Now<i
                        ...
                        <div class="col-lg-6">
                            <div class="details-right">
                                ...
                                <ul class="content-list mt-2">
                                    ...
                                    <li><i class="fas fa-check-circle"></i>Adipisci velit sed quia non numquam eius modi
                                        tempora incidunt.</li>
                                </ul>
                            </div>
                        </div>
        ...
        <div class="feature-area py-120 mt-0">
            <div class="container">
                <div class="row">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="faq-right">
                            ...
                            <a href="how-to-apply.html#" class="theme-btn mt-2">Have Any Question ?</a>
                        </div>
                    </div>
                    <div class="col-lg-6">
