...
@section('content')
    <main class="main">
        ...
        <div class="site-breadcrumb" style="background: url('assets/img/breadcrumb/01.jpg')">
            <div class="container">
                <h2 class="breadcrumb-title">Tuition Fees</h2>
                ...
                <div class="tuition-wrap">
                    ...
                    <div class="mt-4 mb-2">
                        ...
                        <p>Vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum
                            ...
                            aut officiis debitis aut rerum necessitatibus saepe eveniet ut et voluptates repudiandae sint et
                            molestiae non recusandae. Itaque earum rerum hic tenetur a sapiente delectus, ut aut reiciendis
                            voluptatibus maiores alias consequatur aut perferendis doloribus asperiores repellat ighteous
                            indignation and dislike men who are so beguiled and demoralized.</p>
                        <a href="tuition-fee.html#" class="theme-btn mt-4"><span class="far fa-file-pdf"></span> Download
                            Now</a>
                    </div>
                </div>
            </div>
