...
@section('content')
    <main class="main">
        ...
        <div class="site-breadcrumb" style="background: url({{ asset('img/bg/bg-1.png') }})">
            <div class="container">
                <h2 class="breadcrumb-title">Requirements(MDIP)</h2>
                <ul class="breadcrumb-menu">
                    <li><a href="index.html">Admissions</a></li>
                    <li class="active">Requirements(MDIP)</li>
                </ul>
            </div>
        </div>
                        ...
                        <div class="col-xl-4 col-lg-4">
                            <div class="department-sidebar">
                                ...
                                <div class="widget department-download">
                                    ...
                                    <a
                                        href="{{ asset('downloads/Mid-level&Senior DevOps Staff Recruitment_Tiacloud_2023.pdf') }}"><i
