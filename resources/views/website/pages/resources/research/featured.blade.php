...
@section('content')
    <main class="main">
        ...
        <div class="site-breadcrumb" style="background: url({{ asset('img/bg/bg-1.png') }})">
            <div class="container">
                <h2 class="breadcrumb-title">Featured</h2>
        ...
        <div class="research-single-area py-120">
            <div class="container">
                        ...
                        <div class="col-xl-8 col-lg-8">
                            <div class="research-details">
                                <div class="research-details-img mb-30">
                                    <img src="assets/img/research/single.jpg" alt="thumb">
                                </div>
                                <div class="research-details">
                                    <h3 class="mb-20">Science And Technology</h3>
                                    <p class="mb-20">
                                    ...
                                    <div class="my-4">
                                        <div class="mb-3">
                                            <h3 class="mb-3">Research Features</h3>
                                    ...
                                    <div class="my-4">
                                        <h3 class="mb-3">Research Benefits Of Our Students</h3>
                        ...
                        <div class="col-xl-4 col-lg-4">
                            <div class="research-sidebar">
                                <div class="widget category">
                                    <h4 class="widget-title">All Research</h4>
                                    <div class="category-list">
                                        <a href="research-single.html#"><i class="far fa-long-arrow-right"></i>Science And
                                            Technology</a>
                                        <a href="research-single.html#"><i class="far fa-long-arrow-right"></i>Business And
                                            Entrepreneurship</a>
                                        <a href="research-single.html#"><i class="far fa-long-arrow-right"></i>Humanities
                                            And Social Sciences</a>
                                        <a href="research-single.html#"><i class="far fa-long-arrow-right"></i>Allied Health
                                            Sciences</a>
                                        <a href="research-single.html#"><i class="far fa-long-arrow-right"></i>Robort Space
                                            Research</a>
                                        <a href="research-single.html#"><i class="far fa-long-arrow-right"></i>Medical
                                            Machines Research</a>
                                    </div>
                                </div>
                                <div class="widget research-download">
                                    <h4 class="widget-title">Download</h4>
                                    <a href="research-single.html#"><i class="far fa-file-pdf"></i> Download Research</a>
                                    <a href="research-single.html#"><i class="far fa-file-alt"></i> Download Application</a>
                                </div>
                            </div>
                        </div>
                    </div>
