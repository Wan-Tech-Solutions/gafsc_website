...
@section('content')
    <main class="main">
        ...
        <div class="site-breadcrumb" style="background: url({{ asset('img/bg/bg-1.png') }})">
            <div class="container">
                <h2 class="breadcrumb-title">Campus Tour</h2>
                <ul class="breadcrumb-menu">
                    <li><a href="/">Home</a></li>
                    <li><a href="javascript:void(0)">About Us</a></li>
                    <li class="active">Campus Tour</li>
                </ul>
            </div>
        </div>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="content-img wow fadeInLeft" data-wow-delay=".25s"
                            ...
                            <img src="assets/img/campus-tour/01.jpg" alt="">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="content-info wow fadeInUp" data-wow-delay=".25s"
                            ...
                            <div class="site-heading mb-3">
                                <span class="site-title-tagline"><i class="far fa-book-open-reader"></i> Campus Tour</span>
                                <h2 class="site-title">
                                    Details About <span>How To Visit Our</span> Educa.
                                </h2>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="details-left">
                                <h3 class="mb-3">Special Campus Tour</h3>
                                <p>
                        ...
                        <div class="col-lg-6">
                            <div class="details-right">
                                <h3 class="mb-3">Campus Tour Time And Your Tour</h3>
                                <h6 class="my-3">We are open on Monday - Friday at 10am To 4pm, except on holidays.</h6>
                                <p>
                                    There are many variations of passages of Lorem Ipsum available, but the majority have
                                    suffered alteration in some form, by injected humour, or randomised words which don't
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="faq-right">
                            ...
                            <a href="campus-tour.html#" class="theme-btn mt-2">Have Any Question ?</a>
                        </div>
                    </div>
                    <div class="col-lg-6">
