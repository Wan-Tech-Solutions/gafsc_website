  ...
  <div>
    <div class="card text-left">
      <div class="card-header align-items-center d-flex">
        <span class="card-title mb-0 flex-grow-1">Career</span>
        <div class="flex-shrink-0">
          <a :href="route('admin.career.create')" type="button" class="btn btn-soft-primary btn-sm">
            New Career
          </a>
        </div>
      </div>
    ...
    makeDatatable() {
      ...
      $(document).ready(function () {
        var table = $('.books-table').DataTable({
          ajax: this_component.route('api.admin.career.index'),
          serverSide: true,
          order: [[4, 'desc']],
          columns: [
            {
