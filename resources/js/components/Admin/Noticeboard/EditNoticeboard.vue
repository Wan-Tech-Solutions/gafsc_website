        ...
        <div class="card-body">
          ...
          <div class="col-md-12">
            <div class="form-group mb-3 ">
              ...
              <VueFileAgent :uploadUrl="this.route('api.admin.upload.noticeboard') + '?image=' + noticeboard.id"
                :theme="'list'" :accept="'image/*,'" :maxSize="'10MB'" :multiple="false" :uploadHeaders="uploadHeaders"
          ...
          <a class="btn btn-primary" :href="route('admin.noticeboard.index')"> Back</a>
...
export default {
      ...
      this.$modal.show('dialog', {
        ...
        },
        {
          ...
          handler: () => {
            ...
            this.form.patch(this.route('api.admin.noticeboard.update', this.noticeboard.uuid))
              .then(({
                data
              }) => {
  ...
  created() {
    this.noticeboard = window.app.noticeboard
    var data = window.app.noticeboard
