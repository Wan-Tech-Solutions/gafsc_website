  ...
  <div>
    <div class="card text-left">
      <div class="card-header align-items-center d-flex">
        <span class="card-title mb-0 flex-grow-1">Notice Board</span>
        <div class="flex-shrink-0">
          <a :href="route('admin.noticeboard.create')" type="button" class="btn btn-soft-primary btn-sm">
            New Notice
          </a>
        </div>
      </div>
    ...
    makeDatatable() {
      ...
      $(document).ready(function () {
        var table = $('.books-table').DataTable({
          ajax: this_component.route('api.admin.noticeboard.index'),
          serverSide: true,
          order: [[4, 'desc']],
          columns: [
            {
