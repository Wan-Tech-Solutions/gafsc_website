        ...
        <div class="card-body">
          ...
          <div class="col-md-12">
            <div class="form-group mb-3 ">
              ...
              <VueFileAgent :uploadUrl="this.route('api.admin.upload.noticeboard')" :theme="'list'" :accept="'image/*,'"
...
export default {
  ...
  methods: {
    submit() {
      ...
      this.form.post(this.route('api.admin.noticeboard.store'))
        .then(({
          data
        }) => {
          this.form.reset()
    ...
    onUpload(responses) {
      this.form.image = responses[0].data.media
    },
  },
  created() {
  },
