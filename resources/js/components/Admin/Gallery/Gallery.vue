  ...
  <div>
    <div class="card text-left">
      <div class="card-header align-items-center d-flex">
        <span class="card-title mb-0 flex-grow-1">Gallery</span>
        <div class="flex-shrink-0">
          <a :href="route('admin.gallery.create')" type="button" class="btn btn-soft-primary btn-sm">
            New Gallery
          </a>
        </div>
      </div>
    ...
    makeDatatable() {
      ...
      $(document).ready(function () {
        var table = $('.books-table').DataTable({
          ajax: this_component.route('api.admin.gallery.index'),
          serverSide: true,
          columns: [
            {
              data: 'id',
