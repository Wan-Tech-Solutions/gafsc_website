  ...
  u.ClassNavMenu = function () {
    ...
    var t = t || ".nk-menu-toggle",
      ...
      child: "nk-menu-sub"
        ...
        a = e ? f(n, e) : n;
    p(t).on("click", function (t) {
      u.Win.width < d.lg && u.Toggle.dropMenu(p(this), a), t.preventDefault();
    });
  }, u.TGL.showmenu = function (t, e) {
    var n = p(t || ".nk-nav-toggle"),
        a = p("[data-content]"),
        i = a.hasClass(c) ? d.lg : d.xl,
        t = {
    ...
    u.PassSwitch(), u.CurrentLink(), u.LinkOff(".is-disable"), u.ClassNavMenu(), u.SetHW("[data-height]", "height"), u.SetHW("[data-width]", "width"), u.NumberSpinner(), u.Lightbox(".popup-video", "video"), u.Lightbox(".popup-iframe", "iframe"), u.Lightbox(".popup-image", "image"), u.Lightbox(".popup-content", "content"), u.Control(".custom-control-input");
  }, u.Ani.init = function () {
